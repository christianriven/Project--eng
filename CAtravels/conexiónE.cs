...
namespace CAtravels
{
    public class conexiónE
    {
        ...
        {
            int retorno = 0;
            MySqlCommand comando = new MySqlCommand(string.Format("Insert into empresa (Nombre_empresa,	Ubicacion_Empresa, Precio, Promocion_mes, Telefono_contacto, Email_contacto) values ('{0}','{1}','{2}','{3}','{4}','{5}')", Ename, Uempresa, Dempresa, Pempresa, Tempresa, Eempresa), conexionBD.ObtenerConexion());
